...
export function storeReputation$Data(src: Reputation$Data) {
    return (builder: Builder) => {
        ...
        b_0.storeInt(src.scoreValue, 257);
    };
}
...
export function loadReputation$Data(slice: Slice) {
    ...
    const _scoreValue = sc_0.loadIntBig(257);
    return { $$type: 'Reputation$Data' as const, ownerAddress: _ownerAddress, scoreValue: _scoreValue };
}

export function loadTupleReputation$Data(source: TupleReader) {
    const _ownerAddress = source.readAddress();
    const _scoreValue = source.readBigNumber();
    return { $$type: 'Reputation$Data' as const, ownerAddress: _ownerAddress, scoreValue: _scoreValue };
}
...
export function storeTupleReputation$Data(source: Reputation$Data) {
    ...
    builder.writeNumber(source.scoreValue);
    return builder.build();
}
...
async function Reputation_init(owner: Address) {
    const __code = Cell.fromHex('');
...
const Reputation_types: ABIType[] = [
    ...
    {"name":"Reputation$Data","header":null,"fields":[{"name":"ownerAddress","type":{"kind":"simple","type":"address","optional":false}},{"name":"scoreValue","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
]
...
const Reputation_getters: ABIGetter[] = [
    ...
    {"name":"score","methodId":119864,"arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]
...
const Reputation_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"text","text":"bump"}},
]
...
export class Reputation implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: "bump") {
    ...
    async getScore(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('score', builder.build())).stack;
