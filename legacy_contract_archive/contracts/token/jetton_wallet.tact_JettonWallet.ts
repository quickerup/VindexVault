...
export function storeJettonWallet$Data(src: JettonWallet$Data) {
    return (builder: Builder) => {
        ...
        b_0.storeInt(src.walletBalance, 257);
    };
}
...
export function loadJettonWallet$Data(slice: Slice) {
    ...
    const _walletBalance = sc_0.loadIntBig(257);
    return { $$type: 'JettonWallet$Data' as const, ownerAddress: _ownerAddress, walletBalance: _walletBalance };
}

export function loadTupleJettonWallet$Data(source: TupleReader) {
    const _ownerAddress = source.readAddress();
    const _walletBalance = source.readBigNumber();
    return { $$type: 'JettonWallet$Data' as const, ownerAddress: _ownerAddress, walletBalance: _walletBalance };
}
...
export function storeTupleJettonWallet$Data(source: JettonWallet$Data) {
    ...
    builder.writeNumber(source.walletBalance);
    return builder.build();
}
...
async function JettonWallet_init(owner: Address) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initJettonWallet_init_args({ $$type: 'JettonWallet_init_args', owner })(builder);
...
const JettonWallet_types: ABIType[] = [
    ...
    {"name":"JettonWallet$Data","header":null,"fields":[{"name":"ownerAddress","type":{"kind":"simple","type":"address","optional":false}},{"name":"walletBalance","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
]
...
export class JettonWallet implements Contract {
    ...
    static async init(owner: Address) {
        return await JettonWallet_init(owner);
    }
    
    static async fromInit(owner: Address) {
        const __gen_init = await JettonWallet_init(owner);
