...
export function storeJettonMaster$Data(src: JettonMaster$Data) {
    return (builder: Builder) => {
        ...
        b_0.storeInt(src.supplyValue, 257);
    };
}
...
export function loadJettonMaster$Data(slice: Slice) {
    ...
    const _supplyValue = sc_0.loadIntBig(257);
    return { $$type: 'JettonMaster$Data' as const, adminAddress: _adminAddress, supplyValue: _supplyValue };
}

export function loadTupleJettonMaster$Data(source: TupleReader) {
    const _adminAddress = source.readAddress();
    const _supplyValue = source.readBigNumber();
    return { $$type: 'JettonMaster$Data' as const, adminAddress: _adminAddress, supplyValue: _supplyValue };
}
...
export function storeTupleJettonMaster$Data(source: JettonMaster$Data) {
    ...
    builder.writeNumber(source.supplyValue);
    return builder.build();
}
...
async function JettonMaster_init(admin: Address) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initJettonMaster_init_args({ $$type: 'JettonMaster_init_args', admin })(builder);
...
const JettonMaster_types: ABIType[] = [
    ...
    {"name":"JettonMaster$Data","header":null,"fields":[{"name":"adminAddress","type":{"kind":"simple","type":"address","optional":false}},{"name":"supplyValue","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
]
...
export class JettonMaster implements Contract {
    ...
    static async init(admin: Address) {
        return await JettonMaster_init(admin);
    }
    
    static async fromInit(admin: Address) {
        const __gen_init = await JettonMaster_init(admin);
