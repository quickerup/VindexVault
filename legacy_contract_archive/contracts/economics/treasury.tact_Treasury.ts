...
export function storeTreasury$Data(src: Treasury$Data) {
    return (builder: Builder) => {
        ...
        b_0.storeInt(src.treasuryBalance, 257);
    };
}
...
export function loadTreasury$Data(slice: Slice) {
    ...
    const _treasuryBalance = sc_0.loadIntBig(257);
    return { $$type: 'Treasury$Data' as const, ownerAddress: _ownerAddress, treasuryBalance: _treasuryBalance };
}
...
async function Treasury_init(owner: Address) {
    const __code = Cell.fromHex('');
...
const Treasury_types: ABIType[] = [
    ...
    {"name":"Treasury$Data","header":null,"fields":[{"name":"ownerAddress","type":{"kind":"simple","type":"address","optional":false}},{"name":"treasuryBalance","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
]
...
export class Treasury implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: "fund") {
